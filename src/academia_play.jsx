  ...
  return (
    <div className="ap-view ap-view-student">
      <div className="ap-dashboard-grid">
        <div className="ap-hero-card ap-cascade ap-cascade-1 ap-english-lab-entry">
          <APBadge tone="red">{isFreeUser ? 'Inicio gratuito · English LAB' : 'English LAB'}</APBadge>
          <h3>{isFreeUser ? 'Hola, ' + String(first || '').toUpperCase() + '. Empezá practicando con juegos gratis.' : 'Continuá tu ruta por unidades'}</h3>
          <p>{isFreeUser ? 'Esta es una entrada limitada para conocer el Campus y practicar antes de la matrícula oficial. No registra notas ni certificados.' : 'Práctica por nivel, unidad, área y juego desde el banco curricular.'}</p>
          <div className="ap-hero-actions">
...
function AcademiaPlayView({ usuario, role, rolReal, onNavigate }) {
  ...
  return (
    <div className="aplay-shell" data-screen-label="English LAB · juegos">
      <div className="aplay-topbar aplay-topbar-brandonly">
        <div className="aplab-official-brand" aria-label="Academia Norteamericana English LAB">
          <img src="assets/brand/logo_academia_norteamericana_hd.png" alt="Academia Norteamericana" />
        </div>
        <div className="ap-mode-tabs" role="tablist" aria-label="Vistas de English LAB">
          {modes.map(m => (
