// F98.4-Z6-CS21A98 · Panel CONAPE colaborativo + apertura rápida
(function(){
'use strict';
const N=window.ANMasterConape96;if(!N)throw Error('CS21A98 core no cargado');
const BUILD='F98.4-Z6-CS21A98',SNAPSHOT_KEY='an_master_dashboard_snapshot_cs21a98',SYNC_KEY='an_master_conape_last_sync_cs21a98',SYNC_MS=30*60*1000;
...
function MasterConapeMovementsTableCS21A98({data,onRefresh}){
 injectStyles();const d=useConapePanelData(data,onRefresh),r=useConapeReview(d.all,d.setMsg);
...
function install(){if(typeof window.MasterConapeMovementsTable==='function'){window.MasterConapeMovementsTable=MasterConapeMovementsTableCS21A98;window.__AN_MASTER_CONAPE_MOVEMENTS_BUILD__=BUILD}window.useMasterData=useMasterDataCS21A98;window.__AN_MASTER_PERFORMANCE_BUILD__=BUILD}
