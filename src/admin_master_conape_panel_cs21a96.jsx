...
function MasterConapeMovementsTableCS21A96({data,onRefresh}){
 ...
 return <PanelView BUILD={BUILD} data={data} movements={d.movements} busy={d.busy} msg={d.msg} refresh={d.refresh} originalPending={d.originalPending} originalApplied={d.originalApplied} stats={d.stats} visible={d.visible} all={d.all} pending={d.pending} applied={d.applied} hasFilters={d.hasFilters} filterState={filterState} options={{status:d.statusOptions,period:d.periodOptions}} tableProps={tableProps} editor={d.editor} setEditor={d.setEditor} saveDetail={d.saveDetail}/>;
}
function apply(){if(typeof window.MasterConapeMovementsTable!=='function')return;window.MasterConapeMovementsTable=MasterConapeMovementsTableCS21A96;window.__AN_MASTER_CONAPE_MOVEMENTS_BUILD__=BUILD}
