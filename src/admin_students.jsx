              ...
              if (esTraslado) {
                ...
                const abrirPdfTraslado = async () => {
                  ...
                  try {
                    ...
                    if (!abrirPdfBackend(r)) alert('La constancia está disponible, pero no se pudo abrir de forma segura. Intentá de nuevo.');
                    onRefresh?.();
...
function AkHistorialCambiosModal({ codigo, onClose, onReverted }) {
  ...
  async function abrirDocumento(r){
    ...
    try{
      ...
      if(!abrirPdfBackend(resp))alert('El documento está disponible, pero no se pudo abrir de forma segura. Intentá de nuevo.');
      cargar();
  ...
  async function regenerarCarta(r){
    ...
    try{
      ...
      if(!abrirPdfBackend(resp))alert('La carta se regeneró, pero no se pudo abrir de forma segura. Intentá de nuevo.');
      cargar();
    }catch(e){alert(adminStudentsSafeUserError(e?.message||String(e), 'No se pudo completar la operación. Intentá de nuevo.', 'admin_operacion'));}finally{setDocBusy('');}
  }
