...
function SolicitudesEstudianteView({ onNavigate }){
  ...
  return <div data-screen-label="Estudiante · Evaluaciones · Reposiciones" style={{maxWidth:1060,margin:'0 auto',padding:'10px 0 60px'}}>
    <div style={{marginBottom:20,padding:'18px 20px',border:'1px solid var(--line)',borderRadius:16,background:'#fff'}}><div style={{fontSize:10,fontWeight:900,letterSpacing:'.15em',color:'var(--an-granate)'}}>REPOSICIONES DE EXAMEN</div><h1 style={{fontFamily:'var(--f-serif)',fontSize:30,margin:'4px 0 5px'}}>Solicitudes y comprobantes</h1><p style={{margin:0,color:'var(--ink-3)',fontSize:13,lineHeight:1.55}}>Esta sección procesa únicamente reposiciones de evaluaciones. Matrícula y cuotas se consultan en Pagos y estado de cuenta.</p></div>
