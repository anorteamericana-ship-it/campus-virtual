// F98.4-Z6-CS21A142 · Arranque seguro de Recursos Didácticos, Prematrícula y acceso contextual al libro
(function () {
  'use strict';
  ...
  const TEACHER_LESSON_BOOK_SCRIPT_ID = 'an-teacher-lesson-book-link-cs21a142';
  ...
  function loadTeacherLessonBookLink() {
    loadScript(TEACHER_LESSON_BOOK_SCRIPT_ID, 'src/teacher_lesson_book_link_cs21a142.js?v=F98.4Z6CS21A142');
  }
  ...
  window.__AN_RESOURCES_PANEL_STATE_VERSION__ = 'F98.4-Z6-CS21A142';
})();
