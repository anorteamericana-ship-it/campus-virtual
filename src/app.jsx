...
const F96_LAZY = {
  ...
  student_modules: ['src/panel_suspensiones.jsx?v=F98.4A','src/solicitudes_pago.jsx?v=F98.4A','src/solicitudes_unificadas.jsx?v=F98.4A','src/student_modules.jsx?v=F98.4R'],
  ...
  student_evaluations: [
    ...
    'src/student_modules.jsx?v=F98.4R','src/student_experience.jsx?v=F98.4N'
  ],
  student_documents: [
    'src/syllabus_views.jsx?v=F98.4K','src/student_modules.jsx?v=F98.4R','src/student_experience.jsx?v=F98.4N'
  ],
};
