// F98.4-Z6-AI · Panel Maestro Super Admin — Sincronización completa de 10 secciones
...
const MASTER_PANEL_BUILD = 'F98.4-Z6-AI';
...
function MasterCobranza({data,year,compareYear,filters}) {
  ...
  return <>
    ...
    <section className="master-card master-collection-detail-card"><header><div><span>Radiografía financiera</span><h3>Cartera activa por estudiante</h3><p>Pagos aplicados, rubros pendientes, morosidad y certificados</p></div><strong className="master-table-count">{rows.length} estudiante{rows.length===1?'':'s'}</strong></header><MasterCollectionsTable rows={rows}/></section>
