...
- Versión integral/frontend: F98.4-Z6-CS21A51.
...
- Para SB no usar `drive.google.com/file/d/.../preview#page=N`: ese visor puede ignorar el fragmento y abrir la portada.
- Usar la URL directa del PDF con el visor nativo del navegador y `#page=N`.
- Interpretar “mostrar página SB 58” como cargar la página PDF 64, debido al desfase fijo de 6 hojas.
