...
5. La ruta rápida reutiliza el relay CS195 para jugador/estado y evita `_elive180BuildSnapshot_` en el camino aceptado.
6. Answers permanece persistente y dentro del `ScriptLock`; los eventos se escriben en lote persistente inmediatamente después de liberar el lock.
7. Si falta relay, jugador, contrato CS212 o coherencia suficiente, se delega intacto al backend CS212.
...
- Dos órdenes de carrera, retries duplicados, ledger persistente, conflicto legítimo y mismatch 3 s.
