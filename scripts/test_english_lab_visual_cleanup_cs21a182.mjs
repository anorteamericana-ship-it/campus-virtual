...
check(cleanup.includes("hideClosestCardByLabel(root, 'Banco pedagógico'"), 'oculta el diagnóstico interno del banco docente');
...
check(cleanup.includes('Estamos preparando el contenido de esta actividad.'), 'oculta el nombre técnico ACADEMIA_PLAY_BANK');
