...
assert.ok(loader.includes("LATENCY_SAFE_EPOCH = 'CS21A194'"),'Memory Match conserva CS194');
...
console.log(JSON.stringify({ok:true,version:'CS21A200',canonical_order:true,memory_match_owner_preserved:true,quiz_gateway_preserved:true,word_search_endpoints:8,domain_reconciliation:true,retryable_actions_preserved:true,client_solution_leak:false},null,2));
