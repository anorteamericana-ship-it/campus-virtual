...
function scan(file){
  ...
  // V3: any React-style setter plus common direct UI sinks. This captures custom setters
  // such as setMoraError/setErrorGrupos that V2 missed.
  ...
  while((m=re.exec(src))){
    ...
    // Generic state containers only count when the raw value is assigned into an error-like field.
