...
const sourceFiles=[
  ...
  'apps_script_patches/99_CS21A197_MEMORY_MATCH_SPECTATOR_REVEAL_COMPLETO.gs',
];
...
new vm.Script(source,{filename:'CS21A144-CS21A197-QA-CUMULATIVE.gs'}).runInContext(context);
...
const expected=[
  ...
  'CS21A197-MM-SPECTATOR-REVEAL-1',
];
...
console.log(JSON.stringify({
  ok:true,
  contract:'CS21A197_APPS_SCRIPT_CUMULATIVE_RUNTIME_VERIFIER',
