...
const timingNew=`    // CS21A197: iniciar el reveal despues de persistir la respuesta del intento.\n    now = new Date();\n\n    var durationMs = Number(pkg.rules && pkg.rules.round_duration_ms || 30000) || 30000;`;
...
function verify(){
  ...
  console.log(JSON.stringify({ok:true,packageName,files:manifest.length,historicalRevealMs:6000,spectatorRevealMs:8500,historicalContractPreserved:true},null,2));
}
