...
must(!src.includes('No se encontró el panel de recursos adicionales.'), 'internal additional-resources component copy still visible');
must(!src.includes('No se encontró Información General del Programa.'), 'internal program-info component copy still visible');
...
must(src.includes('No pudimos preparar Recursos adicionales. Intentá de nuevo.'), 'additional-resources fallback missing');
must(src.includes('No pudimos preparar Información General del Programa. Intentá de nuevo.'), 'program-info fallback missing');
...
must(src.includes('La ruta académica solicitada no existe.'), 'functional invalid-route message changed unexpectedly');
