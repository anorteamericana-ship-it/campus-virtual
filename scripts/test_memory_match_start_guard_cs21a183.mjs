...
const checks = {
  version: /CS21A183-MM-START-FIX/.test(source),
  ...
  verifierWrapped: /verificarActualizacionQA = function\(\)/.test(source),
  ...
  verifierFlags: /settings_undefined_safe/.test(source) && /created_room_settings_safe/.test(source) && /created_room_package_safe/.test(source),
...
console.log(JSON.stringify({ok:true, contract:'CS21A183_MEMORY_MATCH_START_GUARD', checks}, null, 2));
